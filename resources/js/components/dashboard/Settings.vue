<template>
    <div id="settings-wrapper">
        ...
        <v-menu v-model="menu" :close-on-content-click="false" activator="#settings" bottom content-class="v-settings" 
            left nudge-left="8" offset-x origin="top right" transition="scale-transition">
            ...
            <v-card class="text-center mb-0" width="300">
                <v-card-text>
                    ...
                    <v-btn block class="mb-3" color="success" href="https://www.creative-tim.com/product/vuetify-material-dashboard" default rel="noopener" target="_blank">
                        Free Download
                    </v-btn>

                    <v-btn block class="mb-3" color="grey darken-1" dark href="https://vuetifyjs.com/components/api-explorer" default rel="noopener" target="_blank">
                        Documentation
                    </v-btn>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...mapMutations({ setBarImage: 'SET_BAR_IMAGE' }),
        },
    }
</script>
